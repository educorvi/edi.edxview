...
#
#  $ bin/test -s edi.edxview -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src edi.edxview.testing.EDI_EDXVIEW_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/edi/edxview/tests/robot/test_example.robot
#
